    ...
    let map03 = {
        ...
        init:function(){
            ...
            $('#s_btn').click(function(){
                map03.go(37.5722099 ,126.9768146,'s');
            });
            $('#b_btn').click(function(){
                map03.go(35.1938469 ,129.1536102,'b');
            });
            $('#j_btn').click(function(){
                map03.go(33.2471736 ,126.5521947,'j');
            });
        },
        display:function(){
        ...
        displaymarkers:function(positions){
            ...
            for (var i = 0; i < positions.length; i ++) {
                ...
                kakao.maps.event.addListener(marker, 'click', mouseclickListener(positions[i].id));  //상점의 id
...
<div class="col-sm-8 text-left">
    <div class="container" id="map03">
        ...
        <button id="u_btn" type="button" class="btn btn-primary">성수</button>
        <div id="map"></div>
    </div>
</div>
