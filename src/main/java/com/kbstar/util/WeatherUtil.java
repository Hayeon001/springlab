...
public class WeatherUtil {
    public static String getWeather1(String loc) throws Exception{  // 파싱해서 필요데이터만 뺴내기
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=JoHySVFSYWbuIr%2BfOzeC6jTh8xj0ejLNGPdA5oJuK1Uvi4sd24CVDd%2BIzp7j9fOf87N1GPVGCNRuSG9m%2BaLLOA%3D%3D"); /*Service Key*/
        ...
        JSONObject response = (JSONObject) jo.get("response");    //파싱
    ...
    public static Object getWeather2(String loc) throws Exception{  // 해당 데이터 JSON 정보 리턴  //지역정보를 넣으면 JSONObject
        ...
        String today = ""+year+month+day+"0600";
        //log.info(today);
        ...
        JSONParser jsonParser = new JSONParser();
        JSONObject jo = (JSONObject) jsonParser.parse(sb.toString());   //내려온 데이터 object로 만들어서 던진다
